 ...
 */
class EvaluacionSeminarioInvestigacionQuerys extends ApiQuerys {
  /**
   ...
   */
  async getAlumnos(IdEvaluacionSeminario: number): Promise<Data[]> {
    const integrantes = await this.api<{ data: Data[] }>(
      `integrantes?IdSeminarios_Evaluaciones=${IdEvaluacionSeminario}`
    );
...
export default new EvaluacionSeminarioInvestigacionQuerys(
  process.env.API_URL + '/evaluacion_seminarios_investigacion/'
);
