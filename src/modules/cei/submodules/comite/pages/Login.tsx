...
const Login = () => {
	...
	return (
		...
		>
			...
			<Typography sx={{
				color: 'secondary.main'
			}} component='div' variant='h5' >COMITES POSGRADOS</Typography>
			<Typography sx={{
